// Original Version: https://unpkg.com/pixi-tilemap@2.1.4/lib/pixi-tilemap.es.js
/* eslint-disable */
...
class MultiTextureResource extends Resource {
    constructor(options) {
...
export { CanvasTileRenderer, CompositeRectTileLayer, Constant, GraphicsLayer, MultiTextureResource, POINT_STRUCT_SIZE, RectTileGeom, RectTileLayer, RectTileShader, TileRenderer, TilemapShader, ZLayer, fillSamplers, generateFragmentSrc, generateSampleSrc, pixi_tilemap };
